...
tropicals, a large share of our ornamental grasses, and a number of shrubs.</p>
...
losses happen, and it takes the right environment and a grower who has done it many times before.
That acclimatization work is exactly what you are buying when you order a TC liner from us &mdash;
we absorb that risk so it never reaches your production schedule.</p>
</div>
...
<p>We deliberately do not label varieties &ldquo;TC&rdquo; in our published catalogue, and the reason is
worth understanding: <b>propagation method follows what the customer asks for.</b> The same variety
might go out as a tissue-culture liner for one grower and a cutting or seed-raised plug for another,
depending on the volume, the timing and the finish they need. We propagate to the order, not to a
fixed list.</p>
<div class="tcbox">
...
<a href="/contact.html" style="color:var(--green-dark);font-weight:600;text-decoration:underline">Talk to us about your list</a></p>
</div>
</div>
...
choose when you book. You can order direct or through your broker &mdash; we work with Ball Seed, EHR,
Express Seed, JVK and McHutchison.</p>
...
<div class="tccta">
<a class="btn btn-primary" href="/availability.html">See what ships this week</a>
